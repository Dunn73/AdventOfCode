...
// 38552430
    ...
    public long LowestLocation(Dictionary<long, List<long>> input){
        ...
        long[] test = SeedRange(seedParser("almanac.txt"));
    ...
    public Dictionary<long, List<long>> SeedMapper(string filename){
        ...
        Console.WriteLine($"Seedrange 0: {seedRange[0]}");
        Console.WriteLine($"Seedrange 1: {seedRange[1]}");
        ...
        long count = 0;
        for (long j = 1200000000; j < 1500000000; j++){
            ...
            if (count%10000000 == 0){
                ...
                currentPercent++;
                stopwatch.Start();
                Console.WriteLine($"Loading...{currentPercent}% Total Elapsed time {elapsedTime.TotalSeconds} seconds");
            }
        }
        return output;
    }
